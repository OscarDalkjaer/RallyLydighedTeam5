...
public class CourseController : ControllerBase
{
    ...
    public async Task<IActionResult> GetCourse(int courseId)
    {
        ...
        GetCourseResponse getCourseViewModel = GetCourseResponse.ConvertFromCourse(course);
    ...
    public async Task<IActionResult> UpdateCourse([FromBody] UpdateCourseRequest updateCourseRequestViewModel)
    {
        ...
        {
            UpdateCourseResponse updateCourseResponseViewModel = UpdateCourseResponse.ConvertToUpdateCourseResponse(updatedCourse);                
